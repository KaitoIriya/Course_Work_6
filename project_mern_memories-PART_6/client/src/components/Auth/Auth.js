...
const SignUp = () => {
  ...
  const googleError = () => console.log('Вход в Google не удался. Повторите попытку позже');
        ...
        <form className={classes.form} onSubmit={handleSubmit}>
          <Grid container spacing={2}>
            ...
            <>
              ...
              <Input name="lastName" label="Фамилмя" handleChange={handleChange} half />
            </>
            )}
          ...
          <Grid container justify="flex-end">
            <Grid item>
              <Button onClick={switchMode}>
                { isSignup ? 'Уже есть аккаунт? Войти' : "Еще нет аккаунта? Регистрация" }
              </Button>
            </Grid>
          </Grid>
        </form>
